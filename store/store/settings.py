...
SECRET_KEY = 'django-insecure-zt&bq2t5-^!o*nvz9i302c3^ll%d8=z*ovq*$!k28me@x@cu8^'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'magazin',       # The name of your database
...
STATICFILES_IMAGE_UPLOAD_DIR = 'static/uploads/images/'
